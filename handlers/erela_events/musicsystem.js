...
function generateQueueEmbed(client, guildId, leave) {
  ...
  var embeds = [
    ...
    .setImage("https://cdn.discordapp.com/attachments/848236446170742784/924597658151178250/ezgif.com-gif-maker.jpg?size=4096"),
    new MessageEmbed()
    .setColor(es.color)
    .setFooter(es.footertext, guild.iconURL({
      dynamic: true
    }))
    .setImage("https://cdn.discordapp.com/attachments/848236446170742784/924565844154019900/42982394_687621644958062_8727416645425220908_n.jpg?size=4096")
