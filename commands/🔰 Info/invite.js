...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls) => {
    ...
    if (user) {
      ...
      let button_public_invite = new MessageButton().setStyle('LINK').setLabel(handlemsg(client.la[ls].cmds.info.invite.buttons.public)).setURL("https://discord.com/api/oauth2/authorize?client_id=909383364555988993&permissions=0&scope=bot")
      let button_support_dc = new MessageButton().setStyle('LINK').setLabel(handlemsg(client.la[ls].cmds.info.invite.buttons.server)).setURL("https://discord.gg/kyGRVPh4xs")
      ...
      message.reply({
        embeds: [new MessageEmbed()
          ...
          .setFooter(`${user.username} | powered by Premier Crafty`, "https://imgur.com/jPItIw0.gif")
        ],
